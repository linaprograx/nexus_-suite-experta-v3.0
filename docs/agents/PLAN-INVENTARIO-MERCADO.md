...
| 26 | Inteligencia de proveedores | **hecho** (2026-08-23) — `core/proveedores/perfilProveedor.ts`: gasto y concentración, productos de fuente única, sobrecoste frente a la alternativa comparable, incidencias y condiciones. Frases con su porqué, **sin puntuación sintética** | ✅ |
...
16. Puntos **27 y 28** ✅ **HECHOS 2026-08-23**: son captura, no análisis, y
    ...
    El **26** ✅ **HECHO 2026-08-23**: su mitad de dinero, dependencia y precio
    vive de las compras reales; la de incidencias se enciende sola en cuanto se
    registre la primera. El **11** y el **29** son los siguientes.
