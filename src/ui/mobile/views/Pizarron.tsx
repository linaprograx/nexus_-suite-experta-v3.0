        ...
        <AnimatedPage className="bg-[#EFEEEE] relative overflow-hidden flex flex-col h-full">
            ...
            <div className="flex-1 relative flex overflow-hidden">
                ...
                <aside className="w-16 bg-white/50 backdrop-blur-xl border-r border-white/40 flex flex-col items-center py-6 gap-4 z-40 shadow-lg">
                    <button onClick={() => notify?.('Tool: Select', 'loading')} className="w-10 h-10 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center border border-indigo-100 shadow-sm active:scale-95"><span className="material-symbols-outlined text-lg">near_me</span></button>
                    <button onClick={() => notify?.('Tool: Pan', 'loading')} className="w-10 h-10 rounded-xl text-slate-400 hover:text-slate-800 transition-all active:scale-95"><span className="material-symbols-outlined text-lg">back_hand</span></button>
                    <div className="h-px w-6 bg-slate-300/50 my-1"></div>
                    <button onClick={() => notify?.('Add Image', 'loading')} className="w-10 h-10 rounded-xl text-slate-400 hover:text-slate-800 transition-all active:scale-95"><span className="material-symbols-outlined text-lg">image</span></button>
                    <button onClick={() => notify?.('Add Sticky', 'loading')} className="w-10 h-10 rounded-xl text-slate-400 hover:text-slate-800 transition-all active:scale-95"><span className="material-symbols-outlined text-lg">sticky_note_2</span></button>
                </aside>
                            ...
                            <div className="space-y-4 mb-8">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    ...
                                    <div className="flex items-end">
                                        <NeuButton className="w-full py-4 text-rose-500 font-black uppercase text-[10px]" onClick={() => notify?.("Delete functionality placeholder", 'error')}>
                                            Delete
                                        </NeuButton>
                                    </div>
                                </div>
