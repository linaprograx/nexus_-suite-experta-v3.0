...
const Atmosphere: React.FC<Props> = ({ currentPage }) => {
    const theme = PAGE_THEMES[currentPage] || PAGE_THEMES[PageName.Dashboard];

    return (
        <div className="absolute inset-0 z-0 pointer-events-none overflow-hidden">
            {/* Primary Gradient Orb - Moves and changes color based on page */}
            <motion.div
