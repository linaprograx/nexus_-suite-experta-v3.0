            ...
            <AvatarColumn title="Configuración">
                <div className="space-y-4">
                    ...
                    <div className="mt-auto pt-6">
                        ...
                        <button className="w-full py-3 bg-gradient-to-r from-fuchsia-500 to-indigo-500 text-white font-bold rounded-xl shadow-lg hover:shadow-xl transition-all text-xs flex items-center justify-center gap-2 group">
