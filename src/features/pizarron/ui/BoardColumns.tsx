  ...
  return (
    <div className="relative flex-1 min-h-0 w-full overflow-hidden">
      ...
      <div
        ...
        className="flex flex-row gap-4 overflow-x-auto overflow-y-hidden px-4 no-scrollbar h-full items-start"
      ...
      >
        {columns.map(col => {
          ...
          return (
            <div key={col} className="flex-shrink-0 w-[280px] h-full max-h-full bg-white/5 dark:bg-slate-900/5 rounded-2xl flex flex-col overflow-hidden">
              <KanbanColumn
                title={col}
                status={col}
                tasks={columnTasks}
