    ...
    return (
        <div className={`min-h-full w-full lg:h-full lg:overflow-y-auto bg-gray-50 dark:bg-gray-900 pb-32 transition-all duration-500 custom-scrollbar ${compactMode ? 'p-3' : 'p-3 md:p-6 lg:p-10'}`}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-3 md:gap-6 lg:gap-8">
                ...
                <div className="md:col-span-12 lg:col-span-3 space-y-3 md:space-y-6 animate-in fade-in slide-in-from-left-4 duration-700 delay-100">
                    {leftColumn}
                </div>
                ...
                */}
                <div className="md:col-span-7 lg:col-span-6 space-y-3 md:space-y-6 animate-in fade-in zoom-in-95 duration-700 delay-200">
                    {centerColumn}
                </div>

                {/* Right Column: Intelligence (TR 3 cols) */}
                <div className="md:col-span-5 lg:col-span-3 space-y-3 md:space-y-6 animate-in fade-in slide-in-from-right-4 duration-700 delay-300">
                    {rightColumn}
                </div>
            </div>
        </div>
