      ...
      {recipes.map((recipe) => {
        ...
        return (
          <div
            ...
            className={cn(
              "flex items-center gap-4 rounded-2xl border bg-white/70 dark:bg-slate-900/70 backdrop-blur-md px-4 py-3 mb-3 cursor-pointer shadow-sm hover:shadow-lg hover:-translate-y-0.5 transition-all",
              isSelected ? "border-primary/40 bg-primary/5 ring-1 ring-primary/20" : "border-slate-200 dark:border-slate-800"
            )}
          >
            {/* Thumbnail */}
