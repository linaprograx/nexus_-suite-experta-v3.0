                            ...
                            <div className="p-8 max-w-xl mx-auto w-full animate-in slide-in-from-right-4">
                                ...
                                <div className="space-y-4">
                                    <div className="grid grid-cols-2 gap-4">
                                        ...
                                        <div className="space-y-1"><Label className="text-slate-500 dark:text-slate-400">Categoría</Label><Input className="bg-slate-50 dark:bg-white/10 border-slate-200 dark:border-white/10 text-slate-800 dark:text-white" value={newSupplier.category} onChange={e => setNewSupplier({ ...newSupplier, category: e.target.value as any })} placeholder="Ej. Licores, Fruta..." /></div>
                                    </div>
                                    <div className="grid grid-cols-2 gap-4">
