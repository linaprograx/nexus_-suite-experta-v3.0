...
export const IngredientFormModal: React.FC<{
  isOpen: boolean,
  onClose: () => void,
  db: Firestore,
  userId: string,
  ...
  theme?: 'emerald' | 'blue'
}> = ({ isOpen, onClose, db, userId, appId, editingIngredient, theme = 'emerald' }) => {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg flex flex-col bg-white/90 dark:bg-slate-900/90 backdrop-blur-xl rounded-3xl shadow-2xl border border-white/20 dark:border-white/5 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div className="relative p-6 border-b border-white/10 overflow-hidden">
          <div className={`absolute inset-0 bg-gradient-to-r ${currentTheme.gradient} opacity-100`} />
        ...
        <div className="p-6 space-y-4 overflow-y-auto max-h-[70vh] custom-scrollbar">
          <div className="space-y-4">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <button
                type="button"
                className={`text-[10px] ${currentTheme.text} ${currentTheme.textHover} font-bold uppercase`}
                onClick={() => {
            ...
            <div className="space-y-1">
              ...
              <div className="relative">
                <select
                  name="proveedor"
                  className={`w-full h-10 pl-3 pr-8 bg-white/50 dark:bg-slate-800/50 border-slate-200 dark:border-slate-700 rounded-xl text-sm ${currentTheme.ring} appearance-none`}
        ...
        <div className="p-6 border-t border-slate-200/50 dark:border-slate-700/50 bg-slate-50/50 dark:bg-slate-800/50 flex justify-end gap-3">
          ...
          <Button onClick={handleSubmit} className={`${currentTheme.button} text-white px-6`}>
