...
export const Topbar: React.FC<TopbarProps> = ({
  ...
  return (
    <header className={`sticky top-0 z-30 flex items-center justify-between px-4 transition-all duration-300 
        bg-white/80 backdrop-blur-md border-b border-slate-200/60 shadow-sm
        dark:bg-slate-950/80 dark:border-slate-800/60 dark:shadow-[0_0_20px_rgba(0,0,0,0.4)]
        ${isCompactHeader ? 'h-12 shadow-md' : 'h-16'}`}>
